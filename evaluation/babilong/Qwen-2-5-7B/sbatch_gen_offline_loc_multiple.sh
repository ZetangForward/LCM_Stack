...
bash Qwen-2-5-7B/gen_offline.sh rapid_multiple_api tool_location Qwen/Qwen2.5-7B-Instruct /mnt/hwfile/opendatalab/tangzecheng/benchmark_data /mnt/petrelfs/tangzecheng/local_data/inference_results/Qwen-2-5-7b-instruct api 8